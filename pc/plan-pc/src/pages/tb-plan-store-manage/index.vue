  ...
  <div>
    ...
    <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="100px">
      <el-row>
        <el-col :span='12'>
          <el-form-item label="门店名称" prop="storeName">
            <el-input v-model="dialogFormData.storeName" placeholder="请输入门店名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="策划方案" prop="planId">
            <el-input v-model="dialogFormData.planId" placeholder="请输入策划门店"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="介绍" prop="storeIntroduce">
            <el-input v-model="dialogFormData.storeIntroduce" placeholder="请输入介绍"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
export default {
  name: 'tb-PlanStore-store-manage',
  // 使用 ↓
  components: {
    ISearch,
    ITable,
  ...
  data () {
    return {
      ...
      toolbar: [ //传给子组件的值
        ...
        },
        {
          ...
          func: () => {
            ...
            this.dialogVisible = true
            this.dialogTitle = '修改策划门店'
            req('getPlanStoreById', { // 查看策划门店详情
      ...
      // ],
      columnList: [ //传给子组件的值
        {label: '策划门店名称', prop: 'storeName'},
        {label: '策划方案', prop: 'planName'},
        {label: '说明', prop: 'storeIntroduce'},
        // {label: 'id', prop: 'id'}
      ],
      tableData: [ //传给子组件的值
      ],
      ...
      formRules: {
        storeName: [
          {required: true, message: '请输入策划门店名称', trigger: 'change'}
        ],
        planId: [
          {required: true, message: '请输入策划方案', trigger: 'change'}
        ],
        storeIntroduce: [
        ...
        if (valid) {
          if (this.dialogType === 'add') { // 当表单是新增的时候
            req('savePlanStore', {
              ...
              req('savePlanStore', {...this.dialogFormData}).then(data => {
