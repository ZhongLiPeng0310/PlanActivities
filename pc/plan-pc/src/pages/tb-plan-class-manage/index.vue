  ...
  <div>
    ...
    <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="100px">
      <el-row>
        <el-col :span='12'>
          <el-form-item label="分类名称" prop="className">
            <el-input v-model="dialogFormData.className" placeholder="请输入分类名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
...
export default {
  ...
  data () {
    return {
      ...
      toolbar: [ //传给子组件的值
        ...
        },
        {
          ...
          func: () => {
            ...
            this.dialogVisible = true
            this.dialogTitle = '修改活动分类'
            req('getPlanClassById', { // 查看活动分类详情
      ...
      formRules: {
        className: [
          {required: true, message: '请输入活动分类名称', trigger: 'change'}
        ],
        remark: [
        ...
        if (valid) {
          if (this.dialogType === 'add') { // 当表单是新增的时候
            req('savePlanClass', {
              ...
              req('savePlanClass', {...this.dialogFormData}).then(data => {
