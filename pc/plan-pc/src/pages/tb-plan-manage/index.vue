  ...
  <div>
    ...
    <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="100px">
      <el-row>
        <el-col :span='12'>
          <el-form-item label="活动名称" prop="planName">
            <el-input v-model="dialogFormData.planName" placeholder="请输入活动"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="活动分类" prop="classId">
            <el-input v-model="dialogFormData.classId" placeholder="请输入活动分类"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="策划者" prop="planerId">
            <el-input v-model="dialogFormData.planerId" placeholder="请输入策划者"></el-input>
          </el-form-item>
        </el-col>
       <el-col :span='12'>
          <el-form-item label="起步价" prop="startPrice">
            <el-input v-model="dialogFormData.startPrice" placeholder="请输入起步价"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="物资" prop="goodsId">
            <el-input v-model="dialogFormData.goodsId" placeholder="请输入物资"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="备注" prop="remark">
            <el-input v-model="dialogFormData.remark" placeholder="请输入备注"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
export default {
  ...
  data () {
    return {
      ...
      // ],
      columnList: [ //传给子组件的值
        {label: '活动名称', prop: 'planName'},
        {label: '活动分类名称', prop: 'className'},
        {label: '起步价', prop: 'startPrice'},
        {label: '策划者', prop: 'userName'},
        {label: '物资', prop: 'goodsName'},
      ...
      formRules: {
        ...
        planerId: [
          {required: true, message: '请输入策划者名称', trigger: 'change'}
        ],
        startPrice: [
          {required: true, message: '请输入起步价', trigger: 'change'}
        ],
        goodsId: [
        ...
        if (valid) {
          if (this.dialogType === 'add') { // 当表单是新增的时候
            req('savePlan', {
              ...
              req('savePlan', {...this.dialogFormData}).then(data => {
