<template>
  <div>
    ...
    <!-- <i-search ref="iSearch" :model="formData" @search="fetch" @reset="reset"> 
      <el-form-item label="精选案例名称" prop="SuperPlanName">
        <el-input v-model="formData.SuperPlanName"></el-input>
      </el-form-item>
    </i-search> -->
      ...
      <el-row>
        <el-col :span='12'>
          ...
          <el-form-item label="序号" prop="sort">
            <el-input v-model="dialogFormData.sort" placeholder="请输入序号"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
      ...
      toolbar: [ //传给子组件的值
        ...
        },
        {
          ...
          func: () => {
            ...
            this.dialogVisible = true
            this.dialogTitle = '修改精选案例'
            req('getSuperPlanById', { // 查看精选案例详情
        ...
        if (valid) {
          if (this.dialogType === 'add') { // 当表单是新增的时候
            req('saveSuperPlan', {
              ...
              req('saveSuperPlan', {...this.dialogFormData}).then(data => {
