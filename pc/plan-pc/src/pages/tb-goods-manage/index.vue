  ...
  <div>
    ...
    <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="100px">
      <el-row>
        <el-col :span='12'>
          <el-form-item label="物资名称" prop="goodsName">
            <el-input v-model="dialogFormData.goodsName" placeholder="请输入物资名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
          <el-form-item label="价格" prop="price">
            <el-input v-model="dialogFormData.price" placeholder="请输入价格/元"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span='12'>
      ...
      toolbar: [ //传给子组件的值
        ...
        },
        {
          ...
          func: () => {
            ...
            this.dialogVisible = true
            this.dialogTitle = '修改物资'
            req('getGoodsById', { // 查看物资详情
        ...
        if (valid) {
          if (this.dialogType === 'add') { // 当表单是新增的时候
            req('saveTbGoods', {
              ...
              req('saveTbGoods', {...this.dialogFormData}).then(data => {
