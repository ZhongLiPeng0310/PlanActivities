...
export default {
  ...
  data () {
    return {
      ...
      columnList: [ //传给子组件的值 分页查询的表头
        ...
        {label: '审核情况', prop: 'audit', distName: 'auditState'},
        {label: '保质期/月', prop: 'qualityDate'},
  ...
  methods: {
    ...
    search () { // 查询函数
      req('listAuditGoodsByPage', {
        ...this.formData,
        pageSize: this.pageInfo.pageSize,
        pageNum: this.pageInfo.pageIndex
      }).then(data => {
        console.log('listAuditGoodsByPage_data: ', data)
    ...
    oneChange (value) {
      console.log('一级分类 oneValue', value)
      this.firstId = value
