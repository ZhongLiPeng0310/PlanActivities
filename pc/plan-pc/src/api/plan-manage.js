...
const config = {
  ...
  getTableData: { // 用户管理-分页查询用户列表接口
    url: '/pc/tbUser/listUsersByPage',
    method: 'post'
  },
  addUser: { // 用户管理-新增用户接口
    url: '/pc/tbUser/saveUser',
    method: 'post'
  },
  ...
  getUserDetailData: { // 用户管理-查询用户详情接口
    url: '/pc/tbUser/getUserByUserCode',
    method: 'post'
  },
  deleteUser: { // 用户管理-删除用户接口
    url: '/pc/tbUser/deleteUser',
    method: 'post'
  },
  //-------------------------------------物资管理
  listGoodsByPage: { // 物资管理-分页查询物资列表接口
    url: '/pc/tbGoods/listGoodsByPage',
    method: 'post'
  },
  saveTbGoods: { // 物资管理-保存物资接口
    url: '/pc/tbGoods/saveTbGoods',
    method: 'post'
  },
  getGoodsById: { // 物资管理-查询物资详情接口
    url: '/pc/tbGoods/getGoodsById',
    method: 'post'
  },
  deleteGoods: { // 物资管理-删除物资接口
    url: '/pc/tbGoods/deleteGoods',
    method: 'post'
  },
  //--------------------------------------活动分类管理
  listPlanClassByPage: { // 活动分类管理-分页查询分类列表接口
    url: '/pc/planClass/listPlanClassByPage',
    method: 'post'
  },
  savePlanClass: { // 活动分类管理-保存分类接口
    url: '/pc/planClass/savePlanClass',
    method: 'post'
  },
  getPlanClassById: { // 活动分类管理-查询分类详情接口
    url: '/pc/planClass/getPlanClassById',
    method: 'post'
  },
  deletePlanClass: { // 活动分类管理-删除分类接口
    url: '/pc/planClass/deletePlanClass',
    method: 'post'
  },
  //-------------------------------------活动
  listPlanByPage: { // 活动管理-分页查询活动列表接口
    url: '/pc/plan/listPlanByPage',
    method: 'post'
  },
  savePlan: { // 活动管理-保存活动接口
    url: '/pc/plan/savePlan',
    method: 'post'
  },
  getPlanById: { // 活动管理-查询活动详情接口
    url: '/pc/plan/getPlanById',
    method: 'post'
  },
  deletePlan: { // 活动管理-删除活动接口
    url: '/pc/plan/deletePlan',
    method: 'post'
  },
  //-------------------------------------策划门店
  listPlanStoreByPage: { // 策划门店管理-分页查询策划门店列表接口
    url: '/pc/planStore/listPlanStoreByPage',
    method: 'post'
  },
  savePlanStore: { // 策划门店管理-保存策划门店接口
    url: '/pc/planStore/savePlanStore',
    method: 'post'
  },
  getPlanStoreById: { // 策划门店管理-查询策划门店详情接口
    url: '/pc/planStore/getPlanStoreById',
    method: 'post'
  },
  deletePlanStore: { // 策划门店管理-删除策划门店接口
    url: '/pc/planStore/deletePlanStore',
    method: 'post'
  },
  //-------------------------------------轮播图
  listPictureShowByPage: { // 策划门店管理-分页查询策划门店列表接口
    url: '/pc/tbPictureShow/listTbPictureShowByPage',
    method: 'post'
  },
  savePictureShow: { // 策划门店管理-保存策划门店接口
    url: '/pc/tbPictureShow/saveTbPictureShow',
    method: 'post'
  },
  getPictureShowById: { // 策划门店管理-查询策划门店详情接口
    url: '/pc/tbPictureShow/getTbPictureShowById',
    method: 'post'
  },
  deletePictureShow: { // 策划门店管理-删除策划门店接口
    url: '/pc/tbPictureShow/deleteTbPictureShow',
    method: 'post'
  },
  //-------------------------------------精选案例
  listSuperPlanByPage: { // 策划门店管理-分页查询策划门店列表接口
    url: '/pc/superPlan/listSuperPlanByPage',
    method: 'post'
  },
  saveSuperPlan: { // 策划门店管理-保存策划门店接口
    url: '/pc/superPlan/saveSuperPlan',
    method: 'post'
  },
  getSuperPlanById: { // 策划门店管理-查询策划门店详情接口
    url: '/pc/superPlan/getSuperPlanById',
    method: 'post'
  },
  deleteSuperPlan: { // 策划门店管理-删除策划门店接口
    url: '/pc/superPlan/deleteSuperPlan',
    method: 'post'
  },
