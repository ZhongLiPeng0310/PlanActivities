package com.plan.pc.imageUpload.controller;
...
import com.plan.pc.imageUpload.util.TencentUtil;
...
public class UploadController {
    ...
    public AppResponse uploadImage(@RequestParam("imageFile") MultipartFile[] file){
        ...
        for (int i = 0; i < file.length; i++) {
            ...
            String key = tencentUtil.getQianzhui() + "/"+ tencentUtil.getQianzhui()+ "_" + UUIDUtils.getUUID() + "." + prefix;
            File localFile = null;
            try {
